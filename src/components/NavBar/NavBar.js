	...
	return (
		<>
			<div className='flex flex-justify-between flex-aling-center navbarStyle'>
				<div className='icon'>
					<img
						className='bejamsStyles'
						src='\assets\e-commerce\icons\buhuhu-icon.svg'
						alt='BuhuhuIcon'
					/>
				</div>
				<div className='icon'>
					<button onClick={toggleCart} type='button' className='btn'>
						<img
							className='shopingCartIconStyles'
							src='\assets\e-commerce\icons\shopping-cart.svg'
							alt='shopping-cartIcon'
						/>
